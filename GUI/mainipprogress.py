...
################################################################################
## Form generated from reading UI file 'mainipprogress.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        if QIcon.hasThemeIcon(iconThemeName):
            ...
            icon.addFile(u"C:/Users/\u963f\u601d\u6c57/.designer/backup", QSize(), QIcon.Normal, QIcon.Off)
        
        self.usr_add.setIcon(icon)
        ...
        self.layoutWidget3.setGeometry(QRect(620, 530, 158, 26))
        self.horizontalLayout = QHBoxLayout(self.layoutWidget3)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.exit = QPushButton(self.layoutWidget3)
        self.exit.setObjectName(u"exit")

        self.horizontalLayout.addWidget(self.exit)

        self.start_sim = QPushButton(self.layoutWidget3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionGlobal_config.setText(QCoreApplication.translate("MainWindow", u"Global config", None))
